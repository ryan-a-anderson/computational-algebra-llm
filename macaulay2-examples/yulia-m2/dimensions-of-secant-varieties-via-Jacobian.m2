...
r=3; n=5; d=3; --these parameters will be changed depending on moment variety
...
r=1; n=8; d=6; --these parameters will vary
la={2,2,1,1,0,0,0,0}; --this partition will vary
...
nums={}; nums=apply(length(generators(S)), i -> random(1,1));
--nums={}; nums=apply(length(generators(S)), i -> random(1,100));
toNums=map(QQ,S,nums);
A=toNums(jacobian(ideal(M)));
rank A
